...
function Referent_Data_Base(Data_base, fn)
...
function One_Case(Base_name, n)
  ...
  #  lol = fn[n]
    Data_Base_Name, refrow = Referent_Data_Base(Base_name, fn)
...
return signals_start, Massiv_Amp_all_channels, Massiv_Points_channel,  all_graph_diff, ref
...
signals_start, New_massiv, Massiv_Points_channel, all_graph_diff, ref = all_the(Base_name, n)
