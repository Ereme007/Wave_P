...
function comparison1(Obj1, Obj2, Name_Data_Base, Number_File)
    channel = 1 #Здесь не имеет значение
    Names_files, _, _, _, _, _, Ref_P, _, Massiv_Amp_all_channels, Massiv_Points_channel, _ = ms.all_the1(Name_Data_Base, Number_File)
...
function comparison2(Obj1, Obj2, Name_Data_Base, Number_File)
    channel = 1 #Здесь не имеет значение
    Names_files, _, _, _, _, _, Ref_P, _, Massiv_Amp_all_channels, Massiv_Points_channel, _ = ms.all_the2(Name_Data_Base, Number_File)
...
export comparison1, comparison2
end